...
class CellPopover extends PureComponent {
  ...
  // }
  //
  // componentWillMount = () => this.populateState(this.props.focusedShift || { s: '', e: '', b: '' })
  //
  ...
  //     this.populateState(nextProps.focusedShift || { s: '', e: '', b: '' })
  //     nextProps.focusedShift.e ? this.focusEndTime() : this.focusStartTime()
  //   }
  // }
  //
  ...
  //   const { saveShiftToDB, saveShiftEditToDB, unfocusShiftCell, cell, focusedShift } = this.props
  //   const { day, user, isOpen } = cell
  //   const shiftInput = { startTime, endTime, breakMinutes }
  //
  //   if(isOpen && !position) return // position must be defined if creating an open shift
  //   if(shiftDataValid(shiftInput)){
  //     const minimalShift = zipShift(shiftInput)
  //     let id = focusedShift ? focusedShift.id : generateGuid()
